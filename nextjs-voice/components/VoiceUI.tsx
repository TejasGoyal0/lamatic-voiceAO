...
/**
 * VoiceUI - Client Component for Voice Capture Interface
 * 
 * =============================================================================
 * CLIENT-ONLY COMPONENT
 * =============================================================================
 * 
 * Interactive UI for the voice capture system with:
 * - Start/Stop controls
 * - Real-time energy visualization
 * - State indicators (listening, speaking, paused)
 * - Connection status
 * 
 * =============================================================================
 */
...
export default function VoiceUI() {
  ...
  const handleStart = async () => {
    ...
    if (state.status === 'connecting' || sessionRef.current) {
    ...
    try {
      ...
      const session = createVoiceSession(token, {
        pauseDuration: 3000, // 3 seconds in ms
  ...
  return (
    <div className="flex flex-col items-center gap-6 p-8 max-w-md mx-auto">
      ...
      <div className="text-sm text-gray-500 text-center space-y-1">
        ...
        <p>Speech is streamed via Cloudflare RealtimeKit.</p>
